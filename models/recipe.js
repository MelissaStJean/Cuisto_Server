...
class Recipe{
    ...
    static valid(instance) {
        ...
        validator.addField('RecipeSteps','int');
        validator.addField('RecipeDishesNumber','int');
        validator.addField('RecipeDifficulty','int');
        validator.addField('RecipeRating','int');
        validator.addField('RecipePreparationTime','float');
        validator.addField('RecipeCookingTime','int');
        validator.addField('RecipeCookingTemperature','int');
